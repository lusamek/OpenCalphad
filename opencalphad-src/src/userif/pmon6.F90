...
#elif plotascii 
! Gnuplot-x11 plot screen on some LINUX systems
    graphopt%gnuterminal(1)='caca driver ncurses'//&
         trim(graphopt%font)//',16"'

#elif plotwxt 
! Gnuplot-x11 plot screen on some LINUX systems
    graphopt%gnuterminal(1)='wxt size 600,500 font "'//&
         trim(graphopt%font)//',16"'
!    graphopt%gnuterminal(1)='wxt size 600,500 font "arial,16"'
